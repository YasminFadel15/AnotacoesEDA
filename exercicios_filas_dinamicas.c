...
//Ler duas filas estáticas e retornar a quantidade de números da interseção entre elas
#include <stdio.h>
#include <stdlib.h>
...
int intersecao(FilaEst* fila1, FilaEst* fila2, int n, int m, int valor1[n], int valor2[m]){
    int tamanhoMaximo = (n < m) ? n : m; 
    FilaDin* fila3 = criarDin(tamanhoMaximo);
    int cont = 0;
...
int main(){
    ...
    int quant = intersecao(fila1, fila2, n, m, valor1, valor2);
    printf("Quantidade de números da interseção: %d ", quant);
    printf("\n");
...
//Ler uma fila estática e retornar os valores pares em uma fila dinâmica
#include <stdio.h>
#include <stdlib.h>
...
FilaDin* intersecao(FilaEst* fila1, int n, int valor1[n]){
    int tamanhoMaximo = n; 
    FilaDin* fila3 = criarDin(tamanhoMaximo);
    int cont = 0;
...
int main(){
    ...
    FilaDin* fila3 = intersecao(fila1, n, valor1);
    printf("Valores pares: ");
    for(int i = fila3 -> tamanho - 1 ; i >= 0  ; i--)
        printf("%d ", fila3 -> vetor[i]);
    printf("\n");
